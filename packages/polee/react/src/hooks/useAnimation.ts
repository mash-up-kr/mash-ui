...
export interface CustomAnimation {
  ...
  keyframes: string;
  duration: string;
  options?: Omit<React.CSSProperties, 'animation' | 'animationName' | 'animationDuration'>;
}
...
const injectStyle = (slideAnimationDistance: string, duration: string) => {
  ...
  styleTag.appendChild(document.createTextNode(defaultStyles(slideAnimationDistance, duration)));
